#!/usr/bin/env bash
# openclaw-integration uninstaller — reverses install.sh + Hermes cleanup.
...
for collector in omarchy-agent-usage-openclaw omarchy-agent-usage-grok omarchy-agent-usage-gemini omarchy-agent-usage-hermes omarchy-agent-usage-minimax omarchy-setup-hermes; do
...
for svg in openclaw.svg openclaw-light.svg grok.svg gemini.svg hermes.svg minimax.svg; do
